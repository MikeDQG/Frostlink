...
class Main():
    def __init__(self):
        ...
        logging.basicConfig(filename='final_main_5.log', filemode='w', encoding='utf-8', level=logging.DEBUG, format='%(asctime)s %(module)s %(levelname)s %(message)s', datefmt='%Y/%m/%d %H:%M:%S')
